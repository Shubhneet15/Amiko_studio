...
class FavouriteAdapter (var context: Context,val amikoList: List<WatchLaterListData>): RecyclerView.Adapter<FavouriteAdapter.ViewHolder>(){
    inner class ViewHolder(val binding: ItemrecyclerviewBinding): RecyclerView.ViewHolder(binding.root){
        ...
        init {
            binding.root.setOnClickListener {
                ...
                (context as DashboardActivity).loadFragment(AmikoDetailFragment(amikoList[position].id.toInt()))
